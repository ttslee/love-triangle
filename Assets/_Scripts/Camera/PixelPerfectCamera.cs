...
namespace PixelPerfect
{
    ...
    [
        ExecuteInEditMode,                                       // Allows you to run this script in edit mode to see a preview
        ...
        AddComponentMenu("_Scripts/Camera/Perfect Pixel Camera")    // Insert into the "Add Component..." menu
    ]
    public class PixelPerfectCamera : MonoBehaviour
    {
        ...
        public int TexturePixelsPerWorldUnit = 100;
