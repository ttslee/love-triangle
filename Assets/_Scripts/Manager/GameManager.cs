...
public class GameManager : MonoBehaviour
{
    ...
    List<string> playerMessages = new List<string>
    {
        ...
        "I stopped by that coffee shop you really like today and thought I’d get you something.",
    ...
    Dictionary<string, int> playerMessageDictionary = new Dictionary<string, int>
    {
        ...
        {"I stopped by that coffee shop you really like today and thought I’d get you something.", 15},
        ...
        {"I memorized your favorite boba: wintermelon, 50% sweet, and less ice.", 22 },
